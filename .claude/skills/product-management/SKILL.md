...
description: Справочник по продуктовому менеджменту (PRD, acceptance criteria, приоритизация RICE/MoSCoW, роадмапы, метрики/OKR, пользовательские исследования, UI design systems, конкурентный анализ). Используй, когда тестировщик просит помочь разобрать/структурировать требования как PRD, оценить acceptance criteria, приоритизировать бэклог — не для стандартных QA-задач (тестирование требований по чек-листу, тест-кейсы, Test IT), для них есть testing-requirements/test-case-design/testit-sync.
license: MIT
metadata:
  author: get-zeked
  version: '1.0'
